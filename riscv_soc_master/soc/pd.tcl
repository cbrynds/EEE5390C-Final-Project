...
set lib_path "/home1/local/SAED14nm_EDK_08_2024"
...
### Power Mesh
create_pg_mesh_pattern mesh_pattern -layers {{{vertical_layer: M6} {width: 0.6} {pitch: 50} {offset: 3}} {{horizontal_layer: M5} {width: 0.6} {pitch: 50} {offset: 3}}}
